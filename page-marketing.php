...
<!--SHOWCASE MARKTING IS NOW A SCIENCE-->
            ...
            <div class="parallax-container valign-wrapper">
                <div class="row ">
					...
					<div class="col s12">
                        ...
                        <h1 class="valign blue showcase--title--mobile lighten-1 highlight z-depth-4">MARKETING AND DATA <br>ARE NOW A SCIENCE</h1>
                ...
                <div class="parallax">
                    <img src="<?php bloginfo('template_url') ?>/assets/img/background2.jpg" />
        ...
        <section class="grid-service white section--wrapper">
            <div class="row">
                <h2 class="center-align">WE DO DIGITAL TRANSFORMATION AND WE DO IT GREAT</h2>
            </div>
